...
/*   Updated: 2024/08/19 14:45:42 by yel-moun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef enum _ {  STDIN_IO, STDOUT_IO, FILE_IO, PIPE_IO } IOType;
...
int			ft_get_command_value(char **value, char **expand, char **tmp, t_tokens_list **tokens);
