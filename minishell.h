...
/*   Updated: 2024/08/23 15:03:48 by yel-moun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// tokens functions
void						ft_tokens_addback(t_tokens_list **alst,
								t_tokens_list *new);
...
void						ft_token_skip(t_tokens_list **tokens,
								t_token_type type);
...
void						ft_handle_expand_1(char *buffer, int *i, int *j,
								int *index);
...
t_heredoc					*ft_create_heredoc(t_tokens_list **tokens,
								int list_size);
...
int							ft_open_heredoc(t_heredoc *heredoc_list,
								t_env_list *env_list);
...
t_command_files				*ft_create_files(t_tokens_list **tokens,
								t_env_list *env_list);
...
char						*ft_get_file_name(t_tokens_list **tokens,
								t_env_list *env_list);
// commands functions
t_command					*ft_create_command(t_tokens_list **tokens,
								t_env_list *env_list);
void						ft_command_addback(t_command **alst,
								t_command *new);
...
char						*ft_free_command_value(char *value, char *expand,
								char *tmp);
...
void						fill_command_paths(t_command *command_list,
								t_env_list *env);
void						assign_output(t_command *command,
								t_be_executed *to_execute);
void						assign_input(t_command *command,
								t_be_executed *to_execute);
