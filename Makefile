...
files_files = ft_create_file_node.c ft_files_addback.c ft_files_last.c ft_hanlde_file_name.c ft_heredoc_last.c ft_select_files.c
...
SRC = main.c lexer/ft_special_char.c lexer/ft_count_lexer_tokens.c lexer/ft_extract.c lexer/ft_init_token_list.c \
		...
		execution/ft_clean_heredoc.c execution/ft_fill_heredoc.c execution/ft_open_heredoc.c execution/ft_init_heredoc.c  lexer/ft_remove_quotes.c lexer/ft_create_heredoc.c lexer/ft_heredoc_addback.c lexer/ft_heredoc_size.c execution/ft_is_executed.c \
		execution/ft_is_path.c $(files_prefix)
OBJ = $(SRC:.c=.o)
HEADR = minishell.h
