...
SRC = main.c lexer/ft_special_char.c lexer/ft_count_lexer_tokens.c lexer/ft_extract.c lexer/ft_init_token_list.c \
		...
		lexer/init_execute.c $(bSRC) execution/execute_things.c execution/is_built_in.c execution/execute_commmand.c execution/assign_in_out.c lexer/ft_expend.c lexer/ft_expand_utils.c lexer/ft_expand_2.c  clean/ft_free_array.c clean/ft_clean_tokens.c
OBJ = $(SRC:.c=.o)
HEADR = minishell.h
