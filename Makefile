...
bSRC = builtins/env.c builtins/pwd.c builtins/cd.c builtins/echo.c builtins/print_env_list.c builtins/add_back_for_env.c builtins/get_env_list.c builtins/export.c builtins/unset.c builtins/ft_export_env.c
SRC = main.c lexer/ft_special_char.c lexer/ft_count_lexer_tokens.c lexer/ft_extract.c lexer/ft_init_token_list.c \
		...
		lexer/give_list_pipes.c lexer/print_list_pipes.c lexer/assign_in_out.c lexer/fill_in_out.c lexer/execute_things.c \
